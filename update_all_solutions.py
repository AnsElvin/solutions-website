...
target_file = r'c:\Users\AnSeL\OneDrive\Desktop\2026年程序设计实践例题题解\docs\all-solutions.html'
...
last_end = objects[-1][1] if objects else 0

before = content[:array_start]
after = content[array_start + last_end + 1:]

final_html = before + json.dumps(new_objects, ensure_ascii=False) + after
